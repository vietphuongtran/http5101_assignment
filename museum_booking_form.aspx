                            ...
                            <div>
                                ...
                                <div>
                                    <asp:CheckBoxList runat="server" ID="aspx_visitor_favorite_comic">
                                        <asp:ListItem Text="Marvel Comics Section ($400/person)" Value="Marvel Comics Section"></asp:ListItem>
                                        <asp:ListItem Text="DC Comics Section ($200/person)" Value="DC Comics Section"></asp:ListItem>
                                        <asp:ListItem Text="Manga Section ($100/person)" Value="Manga Section"></asp:ListItem>
                                    </asp:CheckBoxList>
                                </div>
                                ...
                                <div>
                                    <asp:CheckBoxList runat="server" ID="aspx_additional_service">
                                        <asp:ListItem Text="Tourguide ($10/person)" Value="Tourguide"></asp:ListItem>
                                        <asp:ListItem Text="4D Movies ($20/person)" Value="4D Movies"></asp:ListItem>
                                        <asp:ListItem Text="Creating your own comic ($30/person)" Value="Creating your own comic"></asp:ListItem>
                                    </asp:CheckBoxList>
                                </div>
                            </div>
                        </fieldset>
